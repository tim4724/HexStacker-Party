...
var LOCALES = {
  en: {
    ...
    privacy_rights_detail: 'You have the right to access (Art. 15 GDPR), rectification (Art. 16), erasure (Art. 17), restriction of processing (Art. 18), and data portability (Art. 20). To exercise these rights, contact the controller at the e-mail address above. Because the service has no user accounts and stores no gameplay data, most requests will simply confirm that we hold nothing about you (Art. 11(2) GDPR). Your separate right to object under Art. 21 GDPR is set out below.',
  ...
  de: {
    ...
    privacy_hosting: 'Hosting',
    privacy_hosting_detail: 'Die Website wird auf Servern des Verantwortlichen in Deutschland gehostet. Das für Multiplayer genutzte WebSocket-Relay (ws.hexstacker.com) wird für uns von Fly.io, Inc. (Chicago, USA) als Auftragsverarbeiter nach Art. 28 DSGVO betrieben. Da das Relay mehrregional läuft, kann Traffic auch über Standorte außerhalb des EWR geroutet werden; solche Übermittlungen sind durch die EU-Standardvertragsklauseln (Art. 46 Abs. 2 lit. c DSGVO) abgesichert. Eine Kopie der Klauseln stellen wir auf Anfrage bereit.',
    privacy_rights: 'Rechte der Betroffenen',
    privacy_rights_detail: 'Sie haben das Recht auf Auskunft (Art. 15 DSGVO), Berichtigung (Art. 16), Löschung (Art. 17), Einschränkung der Verarbeitung (Art. 18) sowie Datenübertragbarkeit (Art. 20). Zur Ausübung dieser Rechte wenden Sie sich bitte an den Verantwortlichen unter der oben angegebenen E-Mail-Adresse. Da der Dienst ohne Nutzerkonten betrieben wird und keine Spieldaten speichert, werden die meisten Anfragen lediglich bestätigen, dass wir nichts über Sie gespeichert haben (Art. 11 Abs. 2 DSGVO). Ihr gesondertes Widerspruchsrecht nach Art. 21 DSGVO finden Sie weiter unten.',
