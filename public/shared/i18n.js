...
var LOCALES = {
  ...
  de: {
    ...
    start: 'START', start_new_game: 'NEUES SPIEL', watch_trailer: 'Trailer ansehen', close: 'Schließen',
    play_again: 'Nochmal',
  ...
  fr: {
    ...
    start: 'LANCER', start_new_game: 'NOUVELLE PARTIE', watch_trailer: 'Voir la bande-annonce', close: 'Fermer',
    play_again: 'Rejouer',
  ...
  pt: {
    ...
    start: 'INICIAR', start_new_game: 'NOVO JOGO', watch_trailer: 'Ver trailer', close: 'Fechar',
  ...
  es: {
    ...
    start: 'INICIAR', start_new_game: 'NUEVA PARTIDA', watch_trailer: 'Ver tráiler', close: 'Cerrar',
  ...
  zh: {
    ...
    start: '开始', start_new_game: '开始新游戏', watch_trailer: '观看预告片', close: '关闭',
    play_again: '再来一局',
    new_game: '新游戏',
    continue_btn: '继续',
  ...
  ja: {
    ...
    start: 'スタート', start_new_game: '新しいゲームを開始', watch_trailer: '予告編を見る', close: '閉じる',
    play_again: 'もう一度',
    new_game: '新しいゲーム',
    continue_btn: '続ける',
  ...
  ko: {
    ...
    start: '시작', start_new_game: '새 게임 시작', watch_trailer: '예고편 보기', close: '닫기',
    play_again: '다시 하기',
    new_game: '새 게임',
    continue_btn: '계속',
  ...
  ru: {
    ...
    start: 'СТАРТ', start_new_game: 'НОВАЯ ИГРА', watch_trailer: 'Смотреть трейлер', close: 'Закрыть',
  ...
  it: {
    ...
    start: 'AVVIA', start_new_game: 'NUOVA PARTITA', watch_trailer: 'Guarda il trailer', close: 'Chiudi',
  ...
  tr: {
    ...
    start: 'BAŞLAT', start_new_game: 'YENİ OYUN BAŞLAT', watch_trailer: 'Fragmanı izle', close: 'Kapat',
