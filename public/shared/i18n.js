...
var LOCALES = {
  en: {
    ...
    start: 'START',
    mode_party_title: 'Party',
    mode_party_line1: 'Couch multiplayer',
    mode_party_line2: 'Phones as controllers',
    mode_party_meta: '1-8 players',
    mode_classic_title: 'Classic',
    mode_classic_line1: 'Solo stacker',
    mode_classic_line2: 'Keyboard controls',
    mode_classic_meta: 'Local high scores',
    classic_start: 'START CLASSIC',
    classic_name_label: 'Name',
    classic_controls_title: 'Controls',
    classic_controls_move: 'Arrows move / soft drop',
    classic_controls_rotate: 'Z / X / Up rotate',
    classic_controls_drop: 'Space drops',
    classic_controls_hold: 'C / Shift holds',
    classic_controls_pause: 'P / Esc pauses',
    classic_high_scores: 'High Scores',
    classic_no_scores: 'No scores yet',
    classic_new_score: 'Local high score #{rank}',
    classic_score_saved: 'Score saved locally',
