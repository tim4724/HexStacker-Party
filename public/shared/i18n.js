...
var LOCALES = {
  ...
  de: {
    ...
    relay_server_status_label: 'Relay-Server-Status',
    paused: 'PAUSIERT', paused_by: 'Pausiert von {name}', room_not_found: 'Raum nicht gefunden', game_full: 'Raum ist voll',
  ...
  fr: {
    ...
    paused: 'EN PAUSE', paused_by: 'Mis en pause par {name}', room_not_found: 'Salle introuvable', game_full: 'Salle pleine',
  ...
  pt: {
    ...
    paused: 'PAUSADO', paused_by: 'Pausado por {name}', room_not_found: 'Sala não encontrada', game_full: 'Sala cheia',
  ...
  es: {
    ...
    paused: 'PAUSA', paused_by: 'Pausado por {name}', room_not_found: 'Sala no encontrada', game_full: 'Sala llena',
  ...
  zh: {
    ...
    paused: '已暂停', paused_by: '由 {name} 暂停', room_not_found: '房间未找到', game_full: '房间已满',
    game_ended: '游戏已结束',
  ...
  ja: {
    ...
    paused: '一時停止', paused_by: '{name}が一時停止', room_not_found: 'ルームが見つからない', game_full: 'ルームが満員',
    game_ended: 'ゲーム終了',
  ...
  ko: {
    ...
    paused: '일시정지', paused_by: '{name}님이 일시정지', room_not_found: '방을 찾을 수 없어', game_full: '방이 가득 찼어',
    game_ended: '게임 끝',
  ...
  ru: {
    ...
    paused: 'ПАУЗА', paused_by: 'Пауза от {name}', room_not_found: 'Комната не найдена', game_full: 'Комната заполнена',
  ...
  it: {
    ...
    paused: 'IN PAUSA', paused_by: 'In pausa da {name}', room_not_found: 'Stanza non trovata', game_full: 'Stanza piena',
  ...
  tr: {
    ...
    paused: 'DURAKLATILDI', paused_by: '{name} duraklattı', room_not_found: 'Oda bulunamadı', game_full: 'Oda dolu',
