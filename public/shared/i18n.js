...
var LOCALES = {
  ...
  de: {
    ...
    relay_server_status_label: 'Relay-Server-Status',
    paused: 'Pausiert', paused_by: 'von {name}', room_not_found: 'Raum nicht gefunden', game_full: 'Raum ist voll',
  ...
  fr: {
    ...
    paused: 'En pause', paused_by: 'par {name}', room_not_found: 'Salle introuvable', game_full: 'Salle pleine',
  ...
  pt: {
    ...
    paused: 'Pausado', paused_by: 'por {name}', room_not_found: 'Sala não encontrada', game_full: 'Sala cheia',
  ...
  es: {
    ...
    paused: 'Pausa', paused_by: 'por {name}', room_not_found: 'Sala no encontrada', game_full: 'Sala llena',
  ...
  zh: {
    ...
    paused: '已暂停', paused_by: '由 {name}', room_not_found: '房间未找到', game_full: '房间已满',
    game_ended: '游戏已结束',
  ...
  ja: {
    ...
    paused: '一時停止', paused_by: '{name}による', room_not_found: 'ルームが見つからない', game_full: 'ルームが満員',
    game_ended: 'ゲーム終了',
  ...
  ko: {
    ...
    paused: '일시정지', paused_by: '{name}님에 의해', room_not_found: '방을 찾을 수 없어', game_full: '방이 가득 찼어',
    game_ended: '게임 끝',
  ...
  ru: {
    ...
    paused: 'Пауза', paused_by: 'от {name}', room_not_found: 'Комната не найдена', game_full: 'Комната заполнена',
  ...
  it: {
    ...
    paused: 'In pausa', paused_by: 'da {name}', room_not_found: 'Stanza non trovata', game_full: 'Stanza piena',
  ...
  tr: {
    ...
    paused: 'Duraklatıldı', paused_by: '{name} tarafından', room_not_found: 'Oda bulunamadı', game_full: 'Oda dolu',
