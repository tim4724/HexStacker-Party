...
var LOCALES = {
  ...
  de: {
    ...
    privacy_tracking_detail: 'Es werden keine Cookies, keine Analyse- oder Werbedienste und keine Drittanbieter-Tracker eingesetzt. Für den Spielbetrieb unbedingt erforderlich i.S.v. § 25 Abs. 2 Nr. 2 TDDDG ist die lokale Speicherung weniger Einstellungen im Browser des Endgeräts (z. B. zuletzt eingegebener Spielername, gewählte Spielfarbe, Stummschaltung, weitere Anzeigeeinstellungen und eine Wiederverbindungs-ID, die nur für den aktuellen Spielraum gilt). Diese Daten verbleiben ausschließlich im Browser und werden nicht an uns übertragen.',
