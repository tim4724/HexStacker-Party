...
var LOCALES = {
  en: {
    ...
    room_create_failed: 'Couldn\'t create room',
    retry: 'RETRY',
  ...
  pt: {
    ...
    room_create_failed: 'Não foi possível criar a sala',
  ...
  ja: {
    ...
    room_create_failed: 'ルームを作成できません',
    retry: '再試行',
  ...
  ko: {
    ...
    room_create_failed: '방을 만들 수 없습니다',
    retry: '다시 시도',
  ...
  tr: {
    ...
    room_create_failed: 'Oda oluşturulamadı',
    retry: 'TEKRAR DENE',
