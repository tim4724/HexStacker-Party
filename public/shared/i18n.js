...
var LOCALES = {
  ...
  de: {
    ...
    privacy_data: 'Daten',
    privacy_data_detail: 'IP-Adressen werden vom Webserver beim Aufruf der Website verarbeitet. Während einer Multiplayer-Sitzung werden sie zudem von unserem Spielserver verarbeitet, der Nachrichten zwischen den Geräten vermittelt. Bei direkten Verbindungen zwischen Spielgeräten kommt ein Hilfsserver (stun.hexstacker.com) hinzu, der den Geräten beim Verbindungsaufbau hilft (es werden keine Spieldaten darüber übertragen). Zugriffslogs des Webservers werden zu Sicherheits- und Betriebszwecken für maximal 7 Tage gespeichert und anschließend automatisch gelöscht. Der Spielserver speichert selbst keine Verbindungsdaten; etwaige infrastrukturseitige Logs unseres Auftragsverarbeiters werden ausschließlich zu Sicherheits- und Betriebszwecken aufbewahrt. Der Hilfsserver speichert keine Daten persistent.',
