...
var LOCALES = {
  en: {
    ...
    privacy_rights_detail: 'You have the right to access (Art. 15 GDPR), rectification (Art. 16), erasure (Art. 17), restriction of processing (Art. 18), and data portability (Art. 20). To exercise these rights, contact the controller using the e-mail address above. Your separate right to object under Art. 21 GDPR is set out below.',
  ...
  pt: {
    ...
    privacy: 'Privacidade', imprint: 'Impresso',
  ...
  ja: {
    ...
    privacy: 'プライバシー', imprint: '特定商取引法に基づく表記',
