...
var LOCALES = {
  en: {
    ...
    privacy_hosting_detail: 'The website is hosted on servers operated by the controller within Germany. The WebSocket relay used for multiplayer communication (ws.hexstacker.com) is operated on our behalf by Fly.io, Inc., 2045 W Grand Ave Ste B, Chicago, Illinois 60612, USA, as a processor pursuant to Art. 28 GDPR on the basis of a data processing agreement. The relay runs on a multi-region infrastructure that may include locations outside the European Economic Area; transfers of personal data to third countries are safeguarded by the EU Standard Contractual Clauses pursuant to Art. 46(2)(c) GDPR.',
  ...
  de: {
    ...
    privacy_hosting: 'Hosting',
    privacy_hosting_detail: 'Die Website wird auf Servern des Verantwortlichen innerhalb Deutschlands gehostet. Das für die Multiplayer-Kommunikation eingesetzte WebSocket-Relay (ws.hexstacker.com) wird in unserem Auftrag von der Fly.io, Inc., 2045 W Grand Ave Ste B, Chicago, Illinois 60612, USA, als Auftragsverarbeiter im Sinne des Art. 28 DSGVO auf Grundlage eines Auftragsverarbeitungsvertrags betrieben. Das Relay läuft auf einer Multi-Region-Infrastruktur, die auch Standorte außerhalb des Europäischen Wirtschaftsraums umfassen kann; die Übermittlung personenbezogener Daten in Drittländer ist durch die EU-Standardvertragsklauseln gemäß Art. 46 Abs. 2 lit. c DSGVO abgesichert.',
