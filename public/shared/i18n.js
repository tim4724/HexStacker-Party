...
var LOCALES = {
  ...
  de: {
    ...
    privacy_data: 'Daten',
    privacy_data_detail: 'IP-Adressen werden vom Webserver und vom WebSocket-Relay verarbeitet. Beim Aufbau direkter Peer-to-Peer-Verbindungen zwischen Spielgeräten werden sie zudem vom STUN-Server stun.hexstacker.com verarbeitet. Zugriffslogs des Webservers werden zu Sicherheits- und Betriebszwecken für maximal 7 Tage gespeichert und anschließend automatisch gelöscht. Das Relay selbst speichert keine Verbindungsdaten; etwaige infrastrukturseitige Logs unseres Auftragsverarbeiters werden ausschließlich zu Sicherheits- und Betriebszwecken aufbewahrt. Der STUN-Server speichert keine Daten persistent.',
