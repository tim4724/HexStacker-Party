...
var HEX_PIECES = {
  I:  [[-1,0],[0,0],[1,0],[2,0]],          // 4 in a line
  J:  [[-1,1],[0,0],[1,-1],[-1,0]],         // 3 in a row + 1 on top of center
  L:  [[-1,0],[0,0],[1,0],[1,-1]],         // 3 in a row + 1 corner
  O:  [[-1,0],[0,0],[0,-1],[1,-1]],        // compact zigzag (closest to 2x2)
  S:  [[-2,1],[-1,1],[0,0],[1,0]],         // wider zigzag
  T:  [[0,0],[1,0],[-1,1],[0,-1]],         // tripod: center + 3 legs
  Z:  [[-1,1],[0,0],[1,0],[2,-1]],          // mirror zigzag
};
