...
**Gallery**: [main.hexstacker.com/gallery](https://main.hexstacker.com/gallery) — reference pages for the display, the phone, and piece rotations · cross-platform comparison (web vs tvOS vs Android TV): [main.hexstacker.com/tv-gallery/](https://main.hexstacker.com/tv-gallery/)
