...
// the content-hashed CSS bundles that server/index.js serves via Accept-Encoding
// negotiation. Max effort (brotli 11 / gzip 9) is affordable because it's a
// one-shot on immutable bytes; only the primary file is written, callers pass
